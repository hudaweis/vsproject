...
import com.vshuok.es.common.entity.search.exception.InvalidSearchPropertyException;
import com.vshuok.es.common.entity.search.exception.InvalidSearchValueException;
...
public abstract class Searchable {
	 ...
	 */
	public static Searchable newSearchable(
			final Map<String, Object> searchParams) throws SearchException {
	 ...
	 */
	public static Searchable newSearchable(
			final Map<String, Object> searchParams, final Pageable page)
			throws SearchException {
	...
	public static Searchable newSearchable(
			final Map<String, Object> searchParams, final Pageable page,
			final Sort sort) throws SearchException {
	 ...
	 * @throws SearchException
	 */
	public abstract Searchable addSearchParam(final String key,
	 ...
	 * @return
	 */
	public abstract Searchable addSearchParams(
			final Map<String, Object> searchParams) throws SearchException;
	 ...
	 * @return
	 */
	public abstract Searchable or(final SearchFilter first,
	 ...
	 * @return
	 */
	public abstract Searchable and(final SearchFilter first,
			final SearchFilter... others);
	 ...
	 * @return
	 */
	public abstract Searchable removeSearchFilter(String searchProperty,
	...
	public abstract Searchable addSort(final Sort.Direction direction,
			String property);
