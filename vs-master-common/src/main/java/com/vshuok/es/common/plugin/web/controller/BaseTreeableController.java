...
public abstract class BaseTreeableController<M extends BaseEntity<ID> & Treeable<ID>, ID extends Serializable>
	...
	public String tree(
		...
		model.addAttribute(
				"trees",
				convertToZtreeList(request.getContextPath(), models, async,
						true));
	...
	public String deleteSelfAndChildren(Model model, @ModelAttribute("m") M m,
			BindingResult result, RedirectAttributes redirectAttributes) {
	...
	public String appendChild(Model model, @PathVariable("parent") M parent,
	...
	public String showMoveForm(
		...
		searchable.addSearchFilter("parentIds", SearchOperator.notLike,
	...
	public String move(
			...
			@RequestParam("moveType") String moveType, Searchable searchable,
	...
	public String list(HttpServletRequest request,
			@PathVariable("parent") M parent, Searchable searchable, Model model)
		...
		if (parent != null) {
			searchable.addSearchFilter("parentId", SearchOperator.eq,
					parent.getId());
		}
	...
	public Object load(
		...
		return convertToZtreeList(request.getContextPath(), models, async
				&& !asyncLoadAll && parentId != null, onlyCheckLeaf);
	}

	@RequestMapping(value = "ajax/{parent}/appendChild", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
	public Object ajaxAppendChild(HttpServletRequest request,
	...
	@ResponseBody
	public Object ajaxRename(HttpServletRequest request,
			@PathVariable("id") M tree, @RequestParam("newName") String newName) {
	...
	@ResponseBody
	public Object ajaxMove(@PathVariable("sourceId") M source,
	...
	@ResponseBody
	public Set<String> autocomplete(Searchable searchable,
	...
	private List<ZTree<ID>> convertToZtreeList(String contextPath,
			List<M> models, boolean async, boolean onlySelectLeaf) {
