package com.vshuok.es.common.web.entity;
...
public class AjaxUploadResponse {
	...
	public void add(String name, long size, String url, String thumbnail_url,
			String delete_url) {
	...
	public static class FileMeta {
		...
		public FileMeta(String name, long size, String url,
