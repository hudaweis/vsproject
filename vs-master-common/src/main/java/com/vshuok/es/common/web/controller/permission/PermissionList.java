package com.vshuok.es.common.web.controller.permission;
...
public class PermissionList implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8080361694144331857L;
	...
	public static PermissionList newPermissionList(String resourceIdentity) {
		...
		permissionList.resourcePermissions.put(CREATE_PERMISSION,
				resourceIdentity + ":" + CREATE_PERMISSION);
		permissionList.resourcePermissions.put(UPDATE_PERMISSION,
				resourceIdentity + ":" + UPDATE_PERMISSION);
		permissionList.resourcePermissions.put(DELETE_PERMISSION,
				resourceIdentity + ":" + DELETE_PERMISSION);
		permissionList.resourcePermissions.put(VIEW_PERMISSION,
				resourceIdentity + ":" + VIEW_PERMISSION);
	...
	public void addPermission(String permission) {
		resourcePermissions
				.put(permission, resourceIdentity + ":" + permission);
	}
	...
	public void assertHasEditPermission() {
		assertHasAnyPermission(new String[] { CREATE_PERMISSION,
