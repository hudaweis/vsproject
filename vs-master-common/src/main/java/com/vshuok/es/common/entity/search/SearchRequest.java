package com.vshuok.es.common.entity.search;
...
import com.vshuok.es.common.entity.search.filter.*;
import com.vshuok.es.common.entity.search.utils.SearchableConvertUtils;
...
public final class SearchRequest extends Searchable {
	 ...
	 */
	public SearchRequest(final Map<String, Object> searchParams,
			final Pageable page, final Sort sort) throws SearchException {
	...
	@Override
	public Searchable addSearchFilter(final String searchProperty,
			final SearchOperator operator, final Object value) {
		SearchFilter searchFilter = SearchFilterHelper.newCondition(
	...
	@Override
	public Searchable addSearchFilters(
			Collection<? extends SearchFilter> searchFilters) {
	...
	@Override
	public Searchable and(final SearchFilter first,
			final SearchFilter... others) {
	...
	@Override
	public Searchable removeSearchFilter(final String searchProperty,
	...
	@Override
	public Searchable addSort(final Sort.Direction direction,
	...
	public <T> Searchable convert(final Class<T> entityClass) {
		SearchableConvertUtils.convertSearchValueToEntityValue(this,
				entityClass);
		markConverted();
		return this;
	}
	...
	public void removeSort() {
		this.sort = null;
		if (this.page != null) {
			this.page = new PageRequest(page.getPageNumber(),
	...
	private boolean containsSearchKey(List<SearchFilter> searchFilters,
			String key) {
		...
		for (SearchFilter searchFilter : searchFilters) {
			...
			if (searchFilter instanceof Condition) {
				Condition condition = (Condition) searchFilter;
				contains = condition.getKey().equals(key)
