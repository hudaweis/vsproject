package com.vshuok.es.maintain.keyvalue.web.controller;
...
import com.vshuok.es.maintain.keyvalue.service.KeyValueService;
...
public class KeyValueController extends BaseCRUDController<KeyValue, Long> {
	...
	public Object validate(@RequestParam("fieldId") String fieldId,
		...
		if ("key".equals(fieldId)) {
			...
			if (keyValue == null
					|| (keyValue.getId().equals(id) && keyValue.getKey()
							.equals(fieldValue))) {
				// 如果msg 不为空 将弹出提示框
