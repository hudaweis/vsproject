package com.vshuok.es.showcase.parentchild.web.controller;
...
import com.vshuok.es.common.web.bind.annotation.FormModel;
...
import com.vshuok.es.showcase.parentchild.entity.ParentChildType;
import com.vshuok.es.showcase.parentchild.service.ChildService;
import com.vshuok.es.showcase.parentchild.service.ParentService;
...
public class ParentController extends BaseCRUDController<Parent, Long> {
	...
	public String create(Model model,
			@Valid @ModelAttribute("m") Parent parent, BindingResult result,
	...
	public String showUpdateForm(@PathVariable("id") Parent parent, Model model) {
		model.addAttribute("childList", childService.findByParent(parent, null)
				.getContent());
	...
	@ResponseBody
	public Object deleteChildInBatch(
