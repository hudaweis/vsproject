package com.vshuok.es.extra.exception.web.entity;
...
public class ExceptionResponse {
	...
	public static ExceptionResponse from(Throwable e) {
		...
		String errorMessage = "<h3 style='display: inline;'>出错了！</h3><br/>错误信息："
				+ convertMessage(e);
	...
	private static String convertMessage(Throwable e) {
		...
		if (e instanceof UnauthorizedException) {
			...
			if (errorMessage.startsWith("Subject does not have role")) {
				errorMessage = errorMessage.replaceAll(
						"Subject does not have role", "您没有操作权限，请联系管理员添加角色");
			}
		}
