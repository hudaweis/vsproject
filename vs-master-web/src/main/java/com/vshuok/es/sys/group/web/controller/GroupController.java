package com.vshuok.es.sys.group.web.controller;
...
import com.vshuok.es.sys.group.entity.GroupType;
...
new String[] {
				PermissionList.CREATE_PERMISSION, PermissionList.UPDATE_PERMISSION});
