...
<div data-table="table" class="panel">
	...
	<div class="muted">注意：如果想失效所有，只要不输入编号即可</div>
	<br /> <a class="btn btn-evict-all">失效整个二级缓存</a> <a
		class="btn btn-clear-all">清空二级缓存，重新计算</a>
	...
	<div class="form-inline">
		...
		<form class="span7">
			...
			<esform:input path="entityIds" cssClass="input-medium"
				placeholder="多个之间，逗号分隔" />
		</form>
		<div style="line-height: 70px;">
			<a class="btn btn-evict-entity">确定</a> &nbsp;&nbsp; <a
				class="btn btn-evict-entity-all">失效所有实体缓存</a>
		</div>
		<br /> <br /> <br />
		<h4>失效集合缓存：</h4>

		<form class="span7">
			<select id="collectionRoleNames" name="collectionRoleNames"
				multiple="true">
			...
			<esform:input path="collectionEntityIds" cssClass="input-medium"
				placeholder="多个之间，逗号分隔" />
		</form>
		<div style="line-height: 70px;">
			<a class="btn btn-evict-collection">确定</a> &nbsp; <a
				class="btn btn-evict-collection-all">失效所有集合缓存</a>
		</div>
		...
		<div style="line-height: 70px;">
			<a class="btn btn-evict-query">确定</a> &nbsp; <a
				class="btn btn-evict-query-all">失效所有查询缓存</a>
		</div>
