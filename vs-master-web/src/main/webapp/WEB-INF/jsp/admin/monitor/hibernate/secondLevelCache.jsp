...
<div data-table="table" class="panel">
	...
	<ul class="nav nav-pills">
		...
		<li ${param.sort eq 'sizeInMemory' ? "class='active'" : ""}><a
			href="?sort=sizeInMemory">所占内存大小</a></li>
		<li ${param.sort eq 'elementCountInMemory' ? "class='active'" : ""}><a
			href="?sort=elementCountInMemory">内存中的实体数</a></li>
	</ul>
	...
	<table class="table table-bordered">
        ...
        %>
			...
			<c:set var="cacheHitPercent"
				value="${secondLevelCacheStatistics.hitCount * 1.0 / (totalCount)}" />
			...
			<tr>
				...
				<td><fmt:formatNumber value="${cacheHitPercent}"
						maxFractionDigits="2" /></td>
			</tr>
			<tr>
				<td>命中次数:</td>
				<td>${secondLevelCacheStatistics.hitCount}&nbsp;&nbsp; 平均:<fmt:formatNumber
						value="${secondLevelCacheStatistics.hitCount/upSeconds}"
						maxFractionDigits="2" />次/秒
				</td>
			</tr>
			<tr>
				<td>失效次数:</td>
				<td>${secondLevelCacheStatistics.missCount}&nbsp;&nbsp; 平均:<fmt:formatNumber
						value="${secondLevelCacheStatistics.missCount/upSeconds}"
						maxFractionDigits="2" />次/秒
				</td>
			</tr>
			<tr>
				<td>往缓存中Put总次数:</td>
				<td>${secondLevelCacheStatistics.putCount}</td>
			</tr>
			<tr>
				<td style="width: 30%">所占内存大小:</td>
				<td><pretty:prettyMemory
						byteSize="${secondLevelCacheStatistics.sizeInMemory}" /></td>
			</tr>
			<tr>
				<td style="width: 30%">内存中的实体数:</td>
				<td>${secondLevelCacheStatistics.elementCountInMemory}</td>
			</tr>
			<tr>
				<td style="width: 30%">磁盘中的实体数:</td>
				<td>${secondLevelCacheStatistics.elementCountOnDisk}</td>
			</tr>
