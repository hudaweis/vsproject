...
<div data-table="table" class="panel">
	...
	<ul class="nav nav-pills">
		...
		<li ${param.sort eq 'objectCount' ? "class='active'" : ""}><a
			href="?sort=objectCount">内存中对象数</a></li>
	</ul>
	...
	<table class="table table-bordered">
        ...
        %>
			...
			<tr class="bold info">
				<td colspan="2">${cacheName}<a
					href="${ctx}/admin/monitor/ehcache/${cacheName}/details"
					class="btn btn-link no-padding pull-right">详细</a>
				</td>
			</tr>
