...
<div data-table="table" class="panel">
	...
	<table class="table table-bordered">
		<tbody>
			...
			<tr>
				<td>数据库连接次数:</td>
				<td>${statistics.connectCount}平均<fmt:formatNumber
						value="${statistics.connectCount/upSeconds}" maxFractionDigits="2" />次/秒
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>${statistics.closeStatementCount}（Hibernate4bug 没有记录）</td>
			</tr>
			<tr class="error">
			...
			<tr>
				<td>Session打开的次数:</td>
				<td>${statistics.sessionOpenCount}平均<fmt:formatNumber
						value="${statistics.sessionOpenCount/upSeconds}"
						maxFractionDigits="2" />次/秒
				</td>
			</tr>
			<tr>
				<td>Session关闭的次数:</td>
				<td>${statistics.sessionCloseCount}&nbsp;&nbsp; <span
					class="muted">因为OpenSessionInView，所以少一次</span>
				</td>
			</tr>
			<tr>
			...
			<c:set var="secondLevelCacheCount"
				value="${secondLevelCacheCount > 0 ? secondLevelCacheCount : 1}" />
			<c:set var="secondLevelCacheHitPercent"
				value="${statistics.secondLevelCacheHitCount * 1.0 / (secondLevelCacheCount)}" />
			<tr>
				<td>总命中率:</td>
				<td><fmt:formatNumber value="${secondLevelCacheHitPercent}"
						maxFractionDigits="2" /></td>
			</tr>
			<tr>
				<td>命中次数:</td>
				<td>${statistics.secondLevelCacheHitCount}&nbsp;&nbsp; 平均:<fmt:formatNumber
						value="${statistics.secondLevelCacheHitCount/upSeconds}"
						maxFractionDigits="2" />次/秒
				</td>
			</tr>
			<tr>
				<td>失效次数:</td>
				<td>${statistics.secondLevelCacheMissCount}&nbsp;&nbsp; 平均:<fmt:formatNumber
						value="${statistics.secondLevelCacheMissCount/upSeconds}"
						maxFractionDigits="2" />次/秒
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><pretty:prettyMemory byteSize="${usedSystemMemory}" /></td>
			</tr>
			<tr>
				<td style="width: 30%">系统总内存:</td>
				<td><pretty:prettyMemory byteSize="${maxSystemMemory}" /></td>
			</tr>
			<tr>
				<td style="width: 30%">二级缓存使用内存:</td>
				<td><pretty:prettyMemory byteSize="${totalMemorySize}" /></td>
			</tr>
			<tr>
			...
			<c:set var="queryCacheCount"
				value="${statistics.queryCacheHitCount + statistics.queryCacheMissCount}" />
			<c:set var="queryCacheCount"
				value="${queryCacheCount > 0 ? queryCacheCount : 1}" />
			<c:set var="queryCacheHitPercent"
				value="${statistics.queryCacheHitCount * 1.0 / (queryCacheCount)}" />
			<tr>
				<td>总命中率:</td>
				<td><fmt:formatNumber value="${queryCacheHitPercent}"
						maxFractionDigits="2" /></td>
			</tr>
			<tr>
				<td>命中次数:</td>
				<td>${statistics.queryCacheHitCount}&nbsp;&nbsp; 平均:<fmt:formatNumber
						value="${statistics.queryCacheHitCount/upSeconds}"
						maxFractionDigits="2" />次/秒
				</td>
			</tr>
			<tr>
				<td>失效次数:</td>
				<td>${statistics.queryCacheMissCount}&nbsp;&nbsp; 平均:<fmt:formatNumber
						value="${statistics.queryCacheMissCount/upSeconds}"
						maxFractionDigits="2" />次/秒
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>总命中率:</td>
				<td><fmt:formatNumber
						value="${updateTimestampsCacheHitPercent}" maxFractionDigits="2" /></td>
			</tr>
			<tr>
				<td>命中次数:</td>
				<td>${statistics.updateTimestampsCacheHitCount}&nbsp;&nbsp; 平均:<fmt:formatNumber
						value="${statistics.updateTimestampsCacheHitCount/upSeconds}"
						maxFractionDigits="2" />次/秒
				</td>
			</tr>
			<tr>
				<td>失效次数:</td>
				<td>${statistics.updateTimestampsCacheMissCount}&nbsp;&nbsp;
					平均:<fmt:formatNumber
						value="${statistics.updateTimestampsCacheMissCount/upSeconds}"
						maxFractionDigits="2" />次/秒
				</td>
			</tr>
			...
			<c:forEach items="${properties}" var="entry">
				<c:if
					test="${fn:startsWith(entry.key, 'hibernate') or fn:startsWith(entry.key, 'javax') or fn:startsWith(entry.key, 'net')}">
					<tr>
						<td>${entry.key}:</td>
						<td>${entry.value}</td>
					</tr>
			...
			<c:forEach items="${sessionFactory.allClassMetadata}" var="entry">
				...
				<tr>
					<td>${entry.key}:</td>
					<td>实体名:${entry.value.entityName}<br />
