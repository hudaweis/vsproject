...
<div class="panel">
	...
	<ul class="nav nav-tabs">
		<li class="active"><a
			href="${ctx}/admin/sys/group/${group.id}/batch/append?BackURL=<es:BackURL/>">
				<i class="icon-file-alt"></i> ${group.type.info}-批量新增
		</a></li>
	...
	<form id="editForm" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" id="startIds" placeholder="起始编号" /> 到 <input
					type="text" id="endIds" placeholder="结束编号" /> &nbsp; <a
					class="btn btn-success btn-append-range">添加</a>
				<div id="selectedRange" style="line-height: 30px;"></div>
			</div>
		</div>


		<div class="control-group">
			<label for="ids" class="control-label"> 用户编号(批量)<br /> <span
				class="muted">多个逗号分隔</span>
			</label>
			<div class="controls">
				<div style="float: left;">
					<textarea id="ids" name="ids" rows="3" cols="20"
						placeholder="请输入用户编号，多个逗号分隔"></textarea>
				</div>
				...
				<span style="margin-left: 20px; display: inline-block"
					...
					class="btn btn-link" data-toggle="collapse" href="#search-username">
