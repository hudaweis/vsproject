	...
	<form id="editForm" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls input-append" title="选择组织机构">
				<input type="hidden" id="organizationId" name="ids"> <input
					type="text" id="organizationName" class="input-medium"
					readonly="readonly"> <a id="selectOrganizationTree"> <span
		...
		<div class="control-group" style="color: #777;">
			...
			<div class="controls">
				<textarea id="selectedOrganizationName" class="input-xxlarge"
