	...
	<form:form id="editForm" method="post" commandName="user"
		...
		<c:if test="${op eq '查看个人资料' and not empty lastOnline}">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text"
						value="<spring:eval expression='lastOnline.lastLoginTimestamp'/>">
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text"
						value="<spring:eval expression='lastOnline.lastStopTimestamp'/>">
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text"
						value="<time:prettySecond seconds="${lastOnline.totalOnlineTime}"/>" />
				</div>
			</div>
		</c:if>
