...
<div data-table="table" class="panel">
	...
	<ul class="nav nav-tabs">
		<li ${empty param['search.show_eq'] ? 'class="active"' : ''}><a
			href="${ctx}/admin/sys/resource/${parent.id}/children"> <i
				class="icon-table"></i> [${parent.name}]子节点列表
		</a></li>
		<li ${param['search.show_eq'] eq 'true' ? 'class="active"' : ''}>
			<a
			href="${ctx}/admin/sys/resource/${parent.id}/children?search.show_eq=true">
				<i class="icon-table"></i> 显示的
		</a>
		</li>
		<li ${param['search.show_eq'] eq 'false' ? 'class="active"' : ''}>
			<a
			href="${ctx}/admin/sys/resource/${parent.id}/children?search.show_eq=false">
				<i class="icon-table"></i> 隐藏的
		</a>
		</li>
		<li><a href="${ctx}/admin/sys/resource/${parent.id}/update">
			...
			<div class="btn-group">
				<shiro:hasPermission name="sys:resource:create">
					<a class="btn btn-custom no-disabled"
						href="${ctx}/admin/sys/resource/${parent.id}/appendChild?BackURL=<es:BackURL/>">
						<i class="icon-file-alt"></i> 添加子节点
					</a>
				</shiro:hasPermission>
				...
				<shiro:hasPermission name="sys:resource:update">
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							<li><a id="moveTree" class="btn"> <i class="icon-move"></i>
									移动节点
							</a></li>
							<li class="divider"></li>
