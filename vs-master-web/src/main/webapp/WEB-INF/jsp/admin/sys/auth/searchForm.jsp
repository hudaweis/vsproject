...
<form id="searchForm" class="form-inline search-form"
	...
	<input type="submit" class="btn " value="查询" /> <a
		class="btn btn-link btn-clear-search">清空</a>
</form>
