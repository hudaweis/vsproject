		...
		<shiro:hasPermission name="sys:group:create">
			<c:if test="${op eq '新增'}">
				<li ${op eq '新增' ? 'class="active"' : ''}><a
					href="${ctx}/admin/sys/group/${type}/create?BackURL=<es:BackURL/>">
						<i class="icon-file-alt"></i> 新增${type.info}
				</a></li>
			</c:if>
		</shiro:hasPermission>
		...
		<c:if test="${m.type eq 'user'}">
			<div class="control-group">
				...
				<div class="controls inline-radio">
					<form:radiobuttons path="defaultGroup" items="${booleanList}"
