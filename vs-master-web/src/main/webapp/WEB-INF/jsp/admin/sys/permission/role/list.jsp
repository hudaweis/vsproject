...
<div data-table="table" class="panel">
	...
	<ul class="nav nav-tabs">
		<li ${empty param['search.show_eq'] ? 'class="active"' : ''}><a
			href="${ctx}/admin/sys/permission/role"> <i class="icon-table"></i>
				所有角色列表
		</a></li>
		<li ${param['search.show_eq'] eq true ? 'class="active"' : ''}><a
			href="${ctx}/admin/sys/permission/role?search.show_eq=true"> <i
				class="icon-table"></i> 可用角色列表
		</a></li>
		<li ${param['search.show_eq'] eq false ? 'class="active"' : ''}>
			<a href="${ctx}/admin/sys/permission/role?search.show_eq=false">
				<i class="icon-table"></i> 不可用角色列表
		</a>
		</li>
	</ul>
