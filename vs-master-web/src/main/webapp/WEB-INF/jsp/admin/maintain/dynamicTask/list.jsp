	...
	<div class="row-fluid tool ui-toolbar">
		<div class="span4">
			<div class="btn-group">
				...
				<shiro:hasPermission name="maintain:dynamicTask:update">
					<a class="btn btn-custom btn-start"> <i class="icon-trash"></i>
						启动任务
					</a>
				</shiro:hasPermission>

				<shiro:hasPermission name="maintain:dynamicTask:update">
					<a class="btn btn-custom btn-stop"> <i class="icon-trash"></i>
						停止任务
					</a>
				</shiro:hasPermission>
			</div>
