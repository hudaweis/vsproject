...
<ul class="nav nav-tabs">
	<li ${empty param['editorType'] ? 'class="active"' : ''}><a
		href="${ctx}/admin/maintain/editor/edit?path=${path}"> <i
			class="icon-table"></i> 纯文本编辑器
	</a></li>
	<li ${param['editorType'] eq 'html' ? 'class="active"' : ''}><a
		href="${ctx}/admin/maintain/editor/edit?path=${path}&editorType=html">
			<i class="icon-table"></i> html编辑器
	</a></li>
	<li><a href="${ctx}/admin/maintain/editor/list?path=${parentPath}">
			<i class="icon-table"></i> 返回目录
	</a></li>
</ul>
