...
<div class="clearfix">
	<form:form id="editForm" method="post" commandName="model"
		cssClass="row-fluid form-horizontal form-inline">
		...
		<div class="clearfix">
			<form:label path="startDate"
				cssStyle="width: 60px;text-align: right;">开始日期：</form:label>
			<span class="input-append date"> <form:input path="startDate"
					cssClass="validate[required]" cssStyle="width: 180px;"
					data-position="bottom-left" data-format="yyyy-MM-dd" /> <span
		...
		<div class="clearfix">
			<form:label path="startTime"
				cssStyle="width: 60px;text-align: right;">开始时间：</form:label>
			<span class="input-append date"> <form:input path="startTime"
					cssClass="validate[required]" cssStyle="width: 180px;"
					data-position="bottom-left" data-format="hh:mm:ss" /> <span
				class="add-on"><i data-time-icon="icon-time"
					data-date-icon="icon-calendar"></i></span>
			</span>
		...
		<div class="clearfix">
			...
			<span class="input-append date"> <form:input path="endTime"
					cssClass="validate[required]" cssStyle="width: 180px;"
					data-position="bottom-left" data-format="hh:mm:ss" /> <span
				class="add-on"><i data-time-icon="icon-time"
					data-date-icon="icon-calendar"></i></span>
		...
		<div class="clearfix">
			<form:label path="backgroundColor"
				cssStyle="width: 60px;text-align: right;">背景颜色：</form:label>
			<select id="backgroundColor" name="backgroundColor"
				style="background: ${backgroundColorList[0]}">
