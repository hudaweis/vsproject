				...
				<shiro:hasPermission name="showcase:statusAudit:audit">
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							<li><a class="btn btn-link status-success"> <i
									class="icon-pencil"></i> 审核成功
							</a></li>
							<li><a class="btn btn-link status-fail"> <i
									class="icon-pencil"></i> 审核失败
							</a></li>
						</ul>
					</div>
				</shiro:hasPermission>
