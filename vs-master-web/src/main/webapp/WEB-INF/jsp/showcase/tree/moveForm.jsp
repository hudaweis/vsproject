...
<div class="panel">
	...
	<form id="moveForm" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<span class="help-inline" style="padding: 4px;"> <maintain:showIcon
						iconIdentity="${source.icon}" /> ${source.name}
				</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls input-append" title="选择目标节点">
				<input type="hidden" id="targetId" name="target"
					value="${target.id}"> <input type="text" id="targetName"
					name="targetName" value="${target.name}" class="validate[required]"
					readonly="readonly"> <a id="selectTree" href="javascript:;">
		...
		<div class="control-group">
			...
			<div class="controls">
				<button id="moveAsPrev" type="submit" class="btn btn-primary">
					<i class="icon-chevron-left"></i> 之前
				</button>
				<button id="moveAsNext" type="submit" class="btn btn-primary">
					<i class="icon-chevron-right"></i> 之后
				</button>
				<button id="moveAsInner" type="submit" class="btn btn-primary">
					<i class="icon-chevron-down"></i> 孩子节点
				</button>
				<a class="btn" href="<es:BackURL/>"> <i class="icon-reply"></i>
					返回
				</a>
			</div>
		</div>
