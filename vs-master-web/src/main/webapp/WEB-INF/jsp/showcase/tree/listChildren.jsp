...
<div data-table="table" class="panel">
	...
	<ul class="nav nav-tabs">
		<li ${empty param['search.show_eq'] ? 'class="active"' : ''}><a
			href="${ctx}/showcase/tree/${parent.id}/children"> <i
				class="icon-table"></i> [${parent.name}]子节点列表
		</a></li>
		<li ${param['search.show_eq'] eq 'true' ? 'class="active"' : ''}>
			<a
			href="${ctx}/showcase/tree/${parent.id}/children?search.show_eq=true">
				<i class="icon-table"></i> 显示的
		</a>
		</li>
		<li ${param['search.show_eq'] eq 'false' ? 'class="active"' : ''}>
			<a
			href="${ctx}/showcase/tree/${parent.id}/children?search.show_eq=false">
				<i class="icon-table"></i> 隐藏的
		</a>
		</li>
		<li><a href="${ctx}/showcase/tree/${parent.id}/update"> <i
			...
			<div class="btn-group">
				<shiro:hasPermission name="showcase:tree:create">
					<a class="btn btn-custom no-disabled"
						href="${ctx}/showcase/tree/${parent.id}/appendChild?BackURL=<es:BackURL/>">
