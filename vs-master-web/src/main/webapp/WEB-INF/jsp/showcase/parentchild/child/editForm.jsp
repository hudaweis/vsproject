...
<div class="panel">
	...
	<ul class="nav nav-tabs">
		<c:if test="${op eq '新增'}">
			<li ${op eq '新增' ? 'class="active"' : ''}><a> <i
					class="icon-file-alt"></i> 新增
			</a></li>
		</c:if>

		<c:if test="${op eq '复制'}">
			<li class="active"><a> <i class="icon-copy"></i> 复制
			</a></li>
		</c:if>
		<c:if test="${op eq '修改'}">
			<li class="active"><a> <i class="icon-edit"></i> 修改
			</a></li>
		</c:if>
		<li><a href="javascript:$.app.cancelModelDialog();"
			class="btn btn-link"> <i class="icon-remove"></i> 取消
		</a></li>
	</ul>


	<form:form id="childEditForm" method="post" commandName="child"
		...
		<div class="control-group">
			...
			<div class="controls input-append date">
				<form:input path="beginTime" data-format="hh:mm:ss"
					placeholder="例如11:11:11" />
		...
		<div class="control-group">
			...
			<div class="controls input-append date">
				<form:input path="endTime" data-format="hh:mm:ss"
					placeholder="例如11:11:11" />
				<span class="add-on"><i data-time-icon="icon-time"
					data-date-icon="icon-calendar"></i></span>
			</div>
		...
		<div class="control-group">
			<div class="controls">
				...
				<a href="javascript:$.app.cancelModelDialog();" class="btn"> <i
