...
<form id="searchForm" class="form-inline search-form"
	...
	<esform:input path="search.name_like" cssClass="input-small"
		placeholder="模糊匹配" />
	...
	<a class="btn btn-link accordion-toggle" data-toggle="collapse"
		...
		<div class="accordion-inner">
			...
			<div class="input-append date">
				<esform:input path="search.beginDate_gte" cssClass="input-medium"
					data-format="yyyy-MM-dd" placeholder="大于等于" />
			...
			<div class="input-append date">
				<esform:input path="search.endDate_lte" cssClass="input-medium"
					data-format="yyyy-MM-dd" data-position="bottom-left"
					placeholder="小于等于" />
				<span class="add-on"><i data-time-icon="icon-time"
					data-date-icon="icon-calendar"></i></span>
			</div>
