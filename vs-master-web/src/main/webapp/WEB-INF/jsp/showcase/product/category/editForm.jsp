		...
		<shiro:hasPermission name="showcase:productCategory:create">
			<c:if test="${op eq '新增'}">
				<li ${op eq '新增' ? 'class="active"' : ''}><a
					href="${ctx}/showcase/product/category/create?BackURL=<es:BackURL/>">
