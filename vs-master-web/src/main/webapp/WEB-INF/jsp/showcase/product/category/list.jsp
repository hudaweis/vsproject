...
<div data-table="table" class="panel">
	...
	<ul class="nav nav-tabs">
		<li ${empty param['search.show_eq'] ? 'class="active"' : ''}><a
			href="${ctx}/showcase/product/category"> <i class="icon-table"></i>
				所有类别列表
		</a></li>
		<li ${param['search.show_eq'] eq 'true' ? 'class="active"' : ''}>
			<a href="${ctx}/showcase/product/category?search.show_eq=true"> <i
				class="icon-table"></i> 可显示的类别列表
		</a>
		</li>
		<li ${param['search.show_eq'] eq 'false' ? 'class="active"' : ''}>
			<a href="${ctx}/showcase/product/category?search.show_eq=false">
				<i class="icon-table"></i> 隐藏的类别列表
		</a>
		</li>
	</ul>
			...
			<div class="btn-group">
				...
				<div class="btn-group last">
					<a class="btn no-disabled dropdown-toggle" data-toggle="dropdown"
						href="#"> <i class="icon-wrench"></i> 更多操作 <span class="caret"></span>
					</a>
					<ul class="dropdown-menu">
						<shiro:hasPermission
							name="showcase:productCategory:create or showcase:productCategory:update or showcase:productCategory:delete">
							<li><a class="btn no-disabled btn-link reweight"> <i
									class="icon-cog"></i> 优化权重
							</a></li>
						</shiro:hasPermission>
						<shiro:hasPermission name="showcase:product:create">
							<li class="divider"></li>
							<li><a class="btn no-disabled btn-link list-all-product">
									<i class="icon-table"></i> 查看所有产品
							</a></li>
							<li><a class="btn btn-link create-product"> <i
									class="icon-file-alt"></i> 新增选中类别的产品
							</a></li>
						</shiro:hasPermission>
						<li class="divider"></li>
						<li><a class="btn btn-link list-product"> <i
								class="icon-table"></i> 查看选中类别的产品
						</a></li>
