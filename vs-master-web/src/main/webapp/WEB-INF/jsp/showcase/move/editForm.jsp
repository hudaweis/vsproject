		...
		<shiro:hasPermission name="showcase:move:create">
			<c:if test="${op eq '新增'}">
				<li ${op eq '新增' ? 'class="active"' : ''}><a
					href="${ctx}/showcase/move/create?BackURL=<es:BackURL/>"> <i
