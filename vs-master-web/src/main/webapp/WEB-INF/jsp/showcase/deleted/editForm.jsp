		...
		<shiro:hasPermission name="showcase:deleted:create">
			<c:if test="${op eq '新增'}">
				<li ${op eq '新增' ? 'class="active"' : ''}><a
					href="${ctx}/showcase/deleted/create?BackURL=<es:BackURL/>"> <i
