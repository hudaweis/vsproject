...
<div data-table="table" class="panel">
	...
	<ul class="nav nav-tabs">
		<li ${param['search.deleted_eq'] ne 'TRUE' ? 'class="active"' : ''}>
			<a href="${ctx}/showcase/deleted"> <i class="icon-table"></i>
				所有示例列表
		</a>
		</li>
		<li ${param['search.deleted_eq'] eq 'TRUE' ? 'class="active"' : ''}>
			<a href="${ctx}/showcase/deleted?search.deleted_eq=TRUE"> <i
				class="icon-table"></i> 已删除的示例列表
		</a>
		</li>
	</ul>
			...
			<div class="btn-group">
				<shiro:hasPermission name="showcase:deleted:create">
					<a class="btn btn-create" href="${ctx}/showcase/deleted/create">
						<span class="icon-file-alt"></span> 新增
					</a>
				</shiro:hasPermission>
