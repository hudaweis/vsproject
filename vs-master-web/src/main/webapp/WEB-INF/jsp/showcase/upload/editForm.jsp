		...
		<shiro:hasPermission name="showcase:upload:create">
			<c:if test="${op eq '新增'}">
				<li ${op eq '新增' ? 'class="active"' : ''}><a
					href="${ctx}/showcase/upload/create?BackURL=<es:BackURL/>"> <i
	...
	<form:form id="editForm" method="post" commandName="m"
		...
		<c:if test="${not empty m.src}">
			<div class="control-group">
				...
				<div class="controls">
					<es:showAttachment filename="${m.src}" showImage="true"
