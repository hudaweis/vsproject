...
<div id="modal-gallery" class="modal modal-gallery hide fade"
	...
	<div class="modal-footer">
		<a class="btn modal-download" target="_blank"> <i
			class="icon-download"></i> 下载
		</a> <a class="btn btn-success modal-play modal-slideshow"
			data-slideshow="5000"> <i class="icon-play icon-white"></i> 幻灯片显示
		</a> <a class="btn btn-info modal-prev"> <i
			class="icon-arrow-left icon-white"></i> 前一个
		</a> <a class="btn btn-primary modal-next"> 下一个 <i
