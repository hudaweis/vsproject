...
<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
		...
		<ul class="nav">
			<li><a href="http://vshuok.com" target="_blank">私塾在线</a></li>
			<li class="active"><a href="#">登录</a></li>
			<li><a href="http://jinnianshilongnian.iteye.com"
				target="_blank">我的博客</a></li>
			<li><a href="https://github.com/zhangkaitao/es" target="_blank">github</a></li>
		</ul>
		<a class="brand" style="float: right"
			href="mailto:zhangkaitao0503@gmail.com" target="_blank">&nbsp;&nbsp;问题反馈</a>
	</div>
</div>
			...
			<form id="loginForm" method="post" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="input-prepend">
						<span class="add-on icon-user"></span> <input type="text"
				...
				<div class="control-group">
					...
					<div class="input-prepend">
						<span class="add-on icon-key"></span> <input type="password"
				...
				<c:if test="${jcaptchaEbabled}">
					<div class="control-group">
						...
						<div class="input-prepend">
							<span class="add-on icon-circle-blank"></span> <input type="text"
						...
						<img class="jcaptcha-btn jcaptcha-img" style="margin-left: 10px;"
							src="${ctx}/jcaptcha.jpg" title="点击更换验证码"> <a
							class="jcaptcha-btn btn btn-link">换一张</a>
					</div>
				</c:if>

				<div class="control-group">
					<label class="checkbox remember"><input type="checkbox"
						name="rememberMe" value="true">下次自动登录</label> <input
						id="submitForm" type="submit" class="btn btn-login pull-left"
						value="登录">
				</div>
...
<footer class="footer">
	<div class="container">
		<p>
			<a href="http://vshuok.com" target="_blank">私塾在线学习网</a>
		</p>
		<p>
			Code licensed <a href="http://www.apache.org/licenses/LICENSE-2.0"
				target="_blank">Apache License v2.0</a>, documentation under <a
		...
		<ul class="footer-links">
			...
			<li class="muted">·</li>
			<li><a
				href="https://github.com/zhangkaitao/es/issues?state=open"
