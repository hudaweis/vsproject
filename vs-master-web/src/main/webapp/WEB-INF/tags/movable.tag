...
<%@ attribute name="page" type="org.springframework.data.domain.Page"
	required="true" description="分页内容"%>
<%@ attribute name="first" type="java.lang.Boolean" required="true"
	description="是否是分页中的第一个"%>
<%@ attribute name="last" type="java.lang.Boolean" required="true"
	description="是否是分页中的最后一个"%>
...
<div class="moveable ui-widget icon-collection">
	...
	<c:if test="${page.totalElements > 1}">
		<a href="#" class="ui-icon ui-icon-extlink pop-movable" rel="popover"
